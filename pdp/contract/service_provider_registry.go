...
//
// Solidity: function getActiveProvidersByProductType(uint8 productType, uint256 offset, uint256 limit) view returns(((uint256,(address,string,string,bool),(uint8,bytes,string[],bool))[],bool) result)
...
//
// Solidity: function getProvider(uint256 providerId) view returns((address,string,string,bool) info)
...
//
// Solidity: function getProviderByAddress(address providerAddress) view returns((address,string,string,bool) info)
...
//
// Solidity: function getProvidersByProductType(uint8 productType, uint256 offset, uint256 limit) view returns(((uint256,(address,string,string,bool),(uint8,bytes,string[],bool))[],bool) result)
...
//
// Solidity: function providers(uint256 providerId) view returns(address beneficiary, string name, string description, bool isActive)
...
// RegisterProvider is a paid mutator transaction binding the contract method 0x15a954e5.
//
// Solidity: function registerProvider(string name, string description, uint8 productType, bytes productData, string[] capabilityKeys, string[] capabilityValues) payable returns(uint256 providerId)
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactor) RegisterProvider(opts *bind.TransactOpts, name string, description string, productType uint8, productData []byte, capabilityKeys []string, capabilityValues []string) (*types.Transaction, error) {
	return _ServiceProviderRegistry.contract.Transact(opts, "registerProvider", name, description, productType, productData, capabilityKeys, capabilityValues)
}

// RegisterProvider is a paid mutator transaction binding the contract method 0x15a954e5.
//
// Solidity: function registerProvider(string name, string description, uint8 productType, bytes productData, string[] capabilityKeys, string[] capabilityValues) payable returns(uint256 providerId)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) RegisterProvider(name string, description string, productType uint8, productData []byte, capabilityKeys []string, capabilityValues []string) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.RegisterProvider(&_ServiceProviderRegistry.TransactOpts, name, description, productType, productData, capabilityKeys, capabilityValues)
}

// RegisterProvider is a paid mutator transaction binding the contract method 0x15a954e5.
//
// Solidity: function registerProvider(string name, string description, uint8 productType, bytes productData, string[] capabilityKeys, string[] capabilityValues) payable returns(uint256 providerId)
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactorSession) RegisterProvider(name string, description string, productType uint8, productData []byte, capabilityKeys []string, capabilityValues []string) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.RegisterProvider(&_ServiceProviderRegistry.TransactOpts, name, description, productType, productData, capabilityKeys, capabilityValues)
}
...
// TransferProviderBeneficiary is a paid mutator transaction binding the contract method 0x0a1af145.
//
// Solidity: function transferProviderBeneficiary(address newBeneficiary) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactor) TransferProviderBeneficiary(opts *bind.TransactOpts, newBeneficiary common.Address) (*types.Transaction, error) {
	return _ServiceProviderRegistry.contract.Transact(opts, "transferProviderBeneficiary", newBeneficiary)
}

// TransferProviderBeneficiary is a paid mutator transaction binding the contract method 0x0a1af145.
//
// Solidity: function transferProviderBeneficiary(address newBeneficiary) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) TransferProviderBeneficiary(newBeneficiary common.Address) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.TransferProviderBeneficiary(&_ServiceProviderRegistry.TransactOpts, newBeneficiary)
}

// TransferProviderBeneficiary is a paid mutator transaction binding the contract method 0x0a1af145.
//
// Solidity: function transferProviderBeneficiary(address newBeneficiary) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactorSession) TransferProviderBeneficiary(newBeneficiary common.Address) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.TransferProviderBeneficiary(&_ServiceProviderRegistry.TransactOpts, newBeneficiary)
}
...
// ServiceProviderRegistryBeneficiaryTransferredIterator is returned from FilterBeneficiaryTransferred and is used to iterate over the raw logs and unpacked data for BeneficiaryTransferred events raised by the ServiceProviderRegistry contract.
type ServiceProviderRegistryBeneficiaryTransferredIterator struct {
	Event *ServiceProviderRegistryBeneficiaryTransferred // Event containing the contract specifics and raw log
...
func (it *ServiceProviderRegistryBeneficiaryTransferredIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ServiceProviderRegistryBeneficiaryTransferred)
...
func (it *ServiceProviderRegistryBeneficiaryTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ServiceProviderRegistryBeneficiaryTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ServiceProviderRegistryBeneficiaryTransferred represents a BeneficiaryTransferred event raised by the ServiceProviderRegistry contract.
type ServiceProviderRegistryBeneficiaryTransferred struct {
	ProviderId          *big.Int
...
// FilterBeneficiaryTransferred is a free log retrieval operation binding the contract event 0xcac3b813aa052f85279f96655f0ccd339dbf77623d87f74fcd77af7719472d11.
//
// Solidity: event BeneficiaryTransferred(uint256 indexed providerId, address indexed previousBeneficiary, address indexed newBeneficiary)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) FilterBeneficiaryTransferred(opts *bind.FilterOpts, providerId []*big.Int, previousBeneficiary []common.Address, newBeneficiary []common.Address) (*ServiceProviderRegistryBeneficiaryTransferredIterator, error) {
	...
	logs, sub, err := _ServiceProviderRegistry.contract.FilterLogs(opts, "BeneficiaryTransferred", providerIdRule, previousBeneficiaryRule, newBeneficiaryRule)
	if err != nil {
		return nil, err
	}
	return &ServiceProviderRegistryBeneficiaryTransferredIterator{contract: _ServiceProviderRegistry.contract, event: "BeneficiaryTransferred", logs: logs, sub: sub}, nil
}

// WatchBeneficiaryTransferred is a free log subscription operation binding the contract event 0xcac3b813aa052f85279f96655f0ccd339dbf77623d87f74fcd77af7719472d11.
//
// Solidity: event BeneficiaryTransferred(uint256 indexed providerId, address indexed previousBeneficiary, address indexed newBeneficiary)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) WatchBeneficiaryTransferred(opts *bind.WatchOpts, sink chan<- *ServiceProviderRegistryBeneficiaryTransferred, providerId []*big.Int, previousBeneficiary []common.Address, newBeneficiary []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ServiceProviderRegistry.contract.WatchLogs(opts, "BeneficiaryTransferred", providerIdRule, previousBeneficiaryRule, newBeneficiaryRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ServiceProviderRegistryBeneficiaryTransferred)
				if err := _ServiceProviderRegistry.contract.UnpackLog(event, "BeneficiaryTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBeneficiaryTransferred is a log parse operation binding the contract event 0xcac3b813aa052f85279f96655f0ccd339dbf77623d87f74fcd77af7719472d11.
//
// Solidity: event BeneficiaryTransferred(uint256 indexed providerId, address indexed previousBeneficiary, address indexed newBeneficiary)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) ParseBeneficiaryTransferred(log types.Log) (*ServiceProviderRegistryBeneficiaryTransferred, error) {
	event := new(ServiceProviderRegistryBeneficiaryTransferred)
	if err := _ServiceProviderRegistry.contract.UnpackLog(event, "BeneficiaryTransferred", log); err != nil {
		return nil, err
	}
...
//
// Solidity: event ProductAdded(uint256 indexed providerId, uint8 indexed productType, string serviceUrl, address beneficiary, string[] capabilityKeys, string[] capabilityValues)
...
//
// Solidity: event ProductUpdated(uint256 indexed providerId, uint8 indexed productType, string serviceUrl, address beneficiary, string[] capabilityKeys, string[] capabilityValues)
...
// FilterProviderRegistered is a free log retrieval operation binding the contract event 0x585f1c5ef34622f98a20e1f973c5c5a43644292d86f07ab086e992a91c407ea8.
//
// Solidity: event ProviderRegistered(uint256 indexed providerId, address indexed beneficiary)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) FilterProviderRegistered(opts *bind.FilterOpts, providerId []*big.Int, beneficiary []common.Address) (*ServiceProviderRegistryProviderRegisteredIterator, error) {
	...
	logs, sub, err := _ServiceProviderRegistry.contract.FilterLogs(opts, "ProviderRegistered", providerIdRule, beneficiaryRule)
	if err != nil {
		return nil, err
	}
...
// WatchProviderRegistered is a free log subscription operation binding the contract event 0x585f1c5ef34622f98a20e1f973c5c5a43644292d86f07ab086e992a91c407ea8.
//
// Solidity: event ProviderRegistered(uint256 indexed providerId, address indexed beneficiary)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) WatchProviderRegistered(opts *bind.WatchOpts, sink chan<- *ServiceProviderRegistryProviderRegistered, providerId []*big.Int, beneficiary []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ServiceProviderRegistry.contract.WatchLogs(opts, "ProviderRegistered", providerIdRule, beneficiaryRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseProviderRegistered is a log parse operation binding the contract event 0x585f1c5ef34622f98a20e1f973c5c5a43644292d86f07ab086e992a91c407ea8.
//
// Solidity: event ProviderRegistered(uint256 indexed providerId, address indexed beneficiary)
